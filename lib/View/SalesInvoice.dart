...
import 'SalesInvoiceDetails.dart';
import 'loader/Loader.dart';
import 'loader/dot_type.dart';

class OrderSalesInvoice extends StatefulWidget {
  @override
  _OrderSalesInvoiceState createState() => _OrderSalesInvoiceState();
}
var run = true;

class _OrderSalesInvoiceState extends State<OrderSalesInvoice> {
  ...
  getSalesInvoice(dataFrom , dataTo) async{
  ...
  void initState() {
    ...
    print(dateSlug);
    getSalesInvoice(dateSlug, dateSlug);
    super.initState();
  }
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: MaterialButton(
                  ...
                  onPressed: () {
                  Navigator.push(
                      context,MaterialPageRoute(builder: (context) => SalesInvoiceDetails(vouchNo: order.vOHNO)));
                  },
                  child: Row(
                    children: <Widget>[
                      Expanded(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Row(
                                  children: <Widget>[
                                    Text("${AppLocalizations.of(context).translate('SalesInvoicein')} : ",
