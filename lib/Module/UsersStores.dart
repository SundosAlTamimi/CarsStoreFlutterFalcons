class ListUsersStores {
  List<UsersStores> uSERSTORES;

  ListUsersStores({this.uSERSTORES});

  ListUsersStores.fromJson(Map<String, dynamic> json) {
    if (json['ADD_VOUCHER'] != null) {
      uSERSTORES = new List<UsersStores>();
      json['ADD_VOUCHER'].forEach((v) {
        uSERSTORES.add(new UsersStores.fromJson(v));
      });
    }
  }
...
class UsersStores {
  ...
  UsersStores.fromJson(Map<String, dynamic> json) {
